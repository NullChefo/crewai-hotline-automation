...
task1 = Task(
  ...
  Compile your findings in a detailed report. Your final answer MUST be a full analysis report""",
    agent=researcher,
    expected_output="A detailed analysis report on the latest advancements in AI in 2024"
)
...
task2 = Task(
  ...
  implications for the future. Your final answer MUST be the full blog post of at least 3 paragraphs.""",
    agent=writer,
    expected_output="A blog post of at least 3 paragraphs highlighting significant AI advancements"
)
